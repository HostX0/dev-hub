...
import { AiChatDemo, AutomationFlowDemo, CodeDemo, MetricsDemo, IntegrationsDemo } from "./CapabilityDemos";
  ...
  return (
    <section id="capabilities" className="relative scroll-mt-24 py-24 md:py-32">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 h-[700px] w-[900px] -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(34,211,238,0.1),transparent_70%)]" />
      </div>
