...
export function FeaturedProjects({ projects, locale }: { projects: Project[]; locale: Locale }) {
  const t = getDict(locale);
  const Arrow = locale === "ar" ? ArrowUpLeft : ArrowUpRight;
  if (!projects.length) return null;
  return (
    <section id="work" className="relative scroll-mt-24 py-24 md:py-32">
      <div className="pointer-events-none absolute inset-x-0 top-1/3 -z-10 h-[600px] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(124,108,255,0.14),transparent_70%)]" />
